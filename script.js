...
function openMinigame() {
  ...
  if (!hintShown) {
    ...
    startText2.textContent = ' Щасти в риболовлі, переможець отримає подарунковий сет 🍣!';
  } else {
    startTitle.textContent = '🎣 Риболовля!';
    startText1.textContent = 'Ви знайшли секретну мінігру, переможець отримає подарунковий сет 🍣';
